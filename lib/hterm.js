...
// function getTextWidth (text, font, doc) {
//   // if given, use cached canvas for better performance
//   // else, create new canvas
//   var canvas = getTextWidth.canvas || (getTextWidth.canvas = doc.createElement('canvas'));
//   var context = canvas.getContext('2d');
//   context.font = font;
//   var metrics = context.measureText(text);
//
//   console.debug(`measured width ${metrics.width} for text ${text}`);
...
hterm.TextAttributes.prototype.createContainer = function (text) {
  ...
  if(unicodeStringUtils.length(text) > 1) console.debug(text);
